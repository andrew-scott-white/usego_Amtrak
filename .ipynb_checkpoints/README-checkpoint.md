...
10. (aswhite addition) After running base and current cases, run marginal-to-average.run to convert the marginal emissions attributable to Amtrak to average emissions
